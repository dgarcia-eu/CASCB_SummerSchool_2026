...
![](figures/LEIA-Schema.png){.figtop fig-align="center"}
...
:::: {.columns}
::: {.column width="42%"}
![](figures/earth.svg){fig-align="center"}
:::
::: {.column width="58%"}
::: {.roomy}
...
![](figures/earth.svg){.magnifier fig-align="center"}

![](figures/takeHome.svg){fig-align="center"}
...
![](figures/ParisCase.png){.figtop fig-align="center"}

::: {.belowtext}
- Focus on the Paris attacks of **Nov 13, 2015** — removed bots, news media, organizations → **62,114 users**
- Retrieved full user timelines → **>27 million tweets**; emotions measured with **LIWC** (validated dictionaries)
:::
...
:::: {.columns}
::: {.column width="46%"}
![](figures/TS3.png){.figcap fig-align="center"}
:::
::: {.column width="54%"}
...
::: {.fullband .smaller}
**Take-home:** terrorist attacks trigger **collective emotions** that increase **social-resilience** language — those with stronger emotions use more social, prosocial, and shared-value terms. Collective emotions are **not just venting**: they can keep us together (with negative sides too — inter-group conflict, intolerance, short-term orientation).
:::
...
An *in silico* approach: agents ground their behavior in retrieved evidence (**RAG**) rather than relying on "LLM magic".
...
![](figures/CTT-Results.png){.figtop fig-align="center"}
...
![](figures/AI4SOCIAL.svg){.figtop fig-align="center"}
...
::: {.belowtext}
Classic **Asch-style** paradigm ported to AI agents: others around choose a wrong line, color, or count; one option is clearly wrong, so the **base error rate is zero**. Social Impact Theory: conformity grows with the **number**, **similarity**, and **social strength** of sources.
:::
...
:::: {.columns}
::: {.column width="56%"}
![](figures/DunbarQuestion.svg){fig-align="center"}
:::
::: {.column width="44%"}
::: {.roomy}
...
:::: {.columns}
::: {.column width="50%"}
![](figures/OP.svg){fig-align="center"}
:::
::: {.column width="50%"}
::: {.roomy}
...
![](figures/AI-society-5.svg){.figtop fig-align="center"}
...
![](figures/Misalignment1.svg){.figtop fig-align="center"}
...
:::: {.columns}
::: {.column width="58%"}
![](figures/Moltbook1.png){.stackfig fig-align="center"}

![](figures/Moltbook2.png){.stackfig fig-align="center"}

![](figures/Moltbook3.png){.stackfig fig-align="center"}
:::
::: {.column width="42%"}
::: {.roomy}
...
::: {.thankyou}
**Thank you!** — david.garcia@uni-konstanz.de · [www.dgarcia.eu](https://dgarcia.eu) · Bluesky: [@dgarcia.eu](https://bsky.app/profile/dgarcia.bsky.social)
:::
